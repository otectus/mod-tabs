...
public class L2HostilityDifficultyTab extends TabBase {
    ...
    public void openTargetScreen(Player player) {
        try {
            ...
            LegendaryTabs.LOGGER.error("No suitable constructor found for DifficultyScreen");
            
        } catch (Exception e) {
            LegendaryTabs.LOGGER.error("Failed to open L2 Difficulty screen: " + e.getMessage());
        }
    }
    ...
    public Component getTooltip() {
        return Component.translatable("tooltip." + LegendaryTabs.MOD_ID + ".tab.l2_hostility_difficulty.description");
    }
