...
public class CobblemonTab extends TabBase {
    ...
    public void openTargetScreen(Player player) {
        if (Config.Baked.cobblemonTabEnabled && player.level().isClientSide) {
            try {
                ...
                LegendaryTabs.LOGGER.error("Failed to open Cobblemon GUI: " + e.getMessage());
            }
        }
    }
    ...
    public boolean isEnabled(Player player) {
        return Config.Baked.cobblemonTabEnabled && LegendaryTabs.cobblemonLoaded;
    }
    ...
    public Component getTooltip() {
        return Component.translatable("tooltip." + LegendaryTabs.MOD_ID + ".tab.cobblemon.description");
    }
