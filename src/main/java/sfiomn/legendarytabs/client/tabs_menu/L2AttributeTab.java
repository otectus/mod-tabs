...
public class L2AttributeTab extends TabBase {
    ...
    public void openTargetScreen(Player player) {
        try {
            ...
            LegendaryTabs.LOGGER.error("No suitable constructor found for AttributeScreen");
            
        } catch (Exception e) {
            LegendaryTabs.LOGGER.error("Failed to open L2 Attributes screen: " + e.getMessage());
        }
    }
    ...
    public Component getTooltip() {
        return Component.translatable("tooltip." + LegendaryTabs.MOD_ID + ".tab.l2_attributes.description");
    }
