...
public class Config
{
	...
	public static class Baked
	{
		...
		{
			ModTabs.LOGGER.debug("Load Client configuration from file");
			try
			{
			...
			{
				ModTabs.LOGGER.warn("An exception was caused trying to load the client config for Legendary Survival Overhaul.");
				e.printStackTrace();
			}
		}
	}
